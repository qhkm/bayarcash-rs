...
pub fn verify_transaction(data: &TransactionCallbackData, secret_key: &str) -> bool {
    ...
    fields.insert("exchange_reference_number".to_string(), data.exchange_reference_number.clone());
    fields.insert("exchange_transaction_id".to_string(), data.exchange_transaction_id.clone());
    ...
    fields.insert("status_description".to_string(), data.status_description.clone());
...
pub fn verify_direct_debit_bank_approval(data: &DirectDebitBankApprovalCallbackData, secret_key: &str) -> bool {
    let mut fields = BTreeMap::new();
    fields.insert("application_type".to_string(), data.application_type.clone());
    ...
    fields.insert("mandate_reference_number".to_string(), data.mandate_reference_number.clone());
    fields.insert("order_number".to_string(), data.order_number.clone());
    fields.insert("payer_bank_account_no".to_string(), data.payer_bank_account_no.clone());
    fields.insert("payer_bank_code".to_string(), data.payer_bank_code.clone());
    fields.insert("payer_bank_code_hashed".to_string(), data.payer_bank_code_hashed.clone());
    fields.insert("record_type".to_string(), data.record_type.clone());
    create_checksum_value(secret_key, &fields) == data.checksum
}

pub fn verify_direct_debit_authorization(data: &DirectDebitAuthorizationCallbackData, secret_key: &str) -> bool {
    let mut fields = BTreeMap::new();
    fields.insert("amount".to_string(), data.amount.clone());
    fields.insert("currency".to_string(), data.currency.clone());
    fields.insert("datetime".to_string(), data.datetime.clone());
...
pub fn verify_direct_debit_transaction(data: &DirectDebitTransactionCallbackData, secret_key: &str) -> bool {
    let mut fields = BTreeMap::new();
    fields.insert("amount".to_string(), data.amount.clone());
    ...
    fields.insert("mandate_reference_number".to_string(), data.mandate_reference_number.clone());
    fields.insert("record_type".to_string(), data.record_type.clone());
    fields.insert("reference_number".to_string(), data.reference_number.clone());
    fields.insert("status".to_string(), data.status.clone());
    fields.insert("status_description".to_string(), data.status_description.clone());
    fields.insert("transaction_id".to_string(), data.transaction_id.clone());
    create_checksum_value(secret_key, &fields) == data.checksum
